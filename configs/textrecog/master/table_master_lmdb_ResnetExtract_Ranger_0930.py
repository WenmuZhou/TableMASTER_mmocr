...
train_anno_file1 = 'train_data/StructureLabel_val_500/'
# train_img_prefix = ''
# train_anno_file1 = ''
train1 = dict(
    type=dataset_type,
...
valid_anno_file1 = 'train_data/StructureLabel_val_500/'
# valid_img_prefix = ''
# valid_anno_file1 = ''
valid = dict(
    type=dataset_type,
...
test_anno_file1 = 'train_data/StructureLabel_val/'
# test_img_prefix = ''
# test_anno_file1 = ''
test = dict(
    type=dataset_type,
...
data = dict(
    samples_per_gpu=20,
    workers_per_gpu=2,
    train=dict(type='ConcatDataset', datasets=[train1], shuffle=True),
